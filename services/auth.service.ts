      ...
      if (isNetworkError) {
        ...
        const mockUsers: Record<string, UserData> = {
          'owner@fuelflux.com': {
            ...
            phone: '9876543210',
            name: 'Demo Pump Owner',
            roles: ['pump_owner'],
            is_active: true,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            company_name: 'FuelFlux Retail',
          },
          'logistic@fuelflux.com': {
            id: 'usr_logistic',
            ...
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            company_name: 'FuelFlux Logistics',
          },
          'multi@fuelflux.com': {
            id: 'usr_multi',
            email: 'multi@fuelflux.com',
            phone: '9876543210',
            name: 'Demo Multi-Role Exec',
            roles: ['pump_owner', 'logistic', 'admin'],
            is_active: true,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            company_name: 'FuelFlux Enterprise',
          },
        };

        const emailLower = emailOrPhone.toLowerCase();
        let user = mockUsers[emailLower];
        ...
        if (!user) {
          ...
          user = {
            id: `usr_${Date.now()}`,
            email: isEmail ? emailLower : `${emailLower}@fuelflux.com`,
            phone: isEmail ? '9876543210' : emailOrPhone,
            name: 'Mock User (Network Fallback)',
            roles: [role],
            is_active: true,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
        ...
        const mockAccessToken = 'mock_access_token_jwt_signature_fuelflux_development';
        const mockRefreshToken = 'mock_refresh_token_jwt_signature_fuelflux_development';
        ...
        return { accessToken: mockAccessToken, refreshToken: mockRefreshToken, user };
      }
