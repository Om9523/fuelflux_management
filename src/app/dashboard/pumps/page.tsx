...
export default function PumpsPage() {
  const { pumps, addPump, isLoading } = usePumpStore();
                      ...
                      return (
                        ...
                        >
                          ...
                          {!file ? (
                            <button
                              type="button"
                              onClick={() => triggerSimulatedUpload(doc.key, doc.name)}
                              className="flex items-center gap-2 text-xs font-bold text-primary hover:text-primary-hover transition-colors outline-none cursor-pointer"
                            >
